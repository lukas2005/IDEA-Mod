...
public class GuiCustomInv extends GuiContainer
{
	...
	private final CustomInv inventory;

	public GuiCustomInv(EntityPlayer player, InventoryPlayer inventoryPlayer, CustomInv inventoryCustom)
	{
		super(new ContainerCustomInv(player, inventoryPlayer, inventoryCustom));
	...
	public static void drawPlayerModel(int x, int y, int scale, float yaw, float pitch, EntityLivingBase entity) {
		...
		render.playerViewY = 180.0F;
		render.doRenderEntity(entity, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, false);
